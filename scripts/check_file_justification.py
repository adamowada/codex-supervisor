...
FILE_PURPOSES = {
    ...
    "insights/stage8d-review-repair-routing-worker-result.json": FilePurpose(
    ...
    "insights/stage9b-insight-cli-validation-worker-result.json": FilePurpose(
        "structured worker-result evidence for the Stage 9B insight validation CLI slice",
        "check_planning_integrity",
    ),
    "insights/stage9c-insight-update-workflow-worker-result.json": FilePurpose(
    ...
    "insights/stage10c-codex-state-reconciliation-dry-run-worker-result.json": FilePurpose(
    ...
    "insights/stage3c-project-task-seeding-worker-result.json": FilePurpose(
        "structured worker-result evidence for the Stage 3C project task seeding slice",
        "check_planning_integrity",
    ),
    "insights/stage3d-planning-sqlite-adapter-worker-result.json": FilePurpose(
