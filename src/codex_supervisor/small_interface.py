...
from codex_supervisor.recovery import QueueNextResult, queue_next_projection
from codex_supervisor.terminal_transition import terminalize_attempt
from codex_supervisor.work_graph import lineage_to_dicts
...
def queue_next(database_path: Path) -> QueueNextResult:
    ...
    return queue_next_projection(database_path)
